...
public class BookInsertFrame extends JDialog implements ActionListener {
	...
	private BookDB bookDB = new BookDBImpl(); // 객체생성하기 => DB접속, 2개 컬렉션 가져오기 수행..
	...
	public BookInsertFrame() {
		...
		textField.setText("");
		textField.setBounds(74, 33, 116, 21);
		getContentPane().add(textField);
		textField.setColumns(10);

		textField_1 = new JTextField();
		textField_1.setText("");
		textField_1.setBounds(74, 79, 116, 21);
		getContentPane().add(textField_1);
		textField_1.setColumns(10);

		textField_2 = new JTextField();
		textField_2.setText("");
		textField_2.setBounds(74, 128, 116, 21);
		getContentPane().add(textField_2);
		textField_2.setColumns(10);

		this.textField_3 = new JTextField();
		textField_3.setText("");
		textField_3.setBounds(74, 173, 116, 21);
		getContentPane().add(textField_3);
		textField_3.setColumns(10);

		this.btnNewButton = new JButton("등록하기");
		btnNewButton.setBounds(84, 213, 97, 23);
